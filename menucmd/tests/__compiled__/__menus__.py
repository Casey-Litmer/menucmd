...
config_menu.append(
    cfg.settings_item(),
    cfg.history_item( menu_name = "Command History", message = "Show Command History", callback = print),
    Item(
        key = 'z',
        message = 'Clear Command History',
        funcs = [
            (cfg.clear_history, (result.CONFIG,)),
    ...
    Item(
        ...
        funcs = [
            (run_command, ()),
            (escape_on, (result, None,)),
            (cfg.add_to_history, (result.CONFIG[0], result.COMMAND,)),
            (cfg.save_config, (result.CONFIG,)),
        ]
    ),
)
